...
def test_send_otp_email_smtp_relay_success(monkeypatch):
    ...
    monkeypatch.setattr(settings, "smtp_user", "brevo-user@example.com")
    monkeypatch.setattr(settings, "smtp_password", "brevo-key")
    ...
    with patch("smtplib.SMTP") as mock_smtp_cls:
        ...
        mock_server.login.assert_called_once_with("brevo-user@example.com", "brevo-key")
